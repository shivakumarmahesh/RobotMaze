/*
 * The file GrandFinale2.java is a part of the second course-work required to be submitted for evaluation
 * of the CS118 module. 
 * 
...
class RobotData {
	 ...
	 * </p>
	 */
	Junction junctionStack[] = new Junction[maxJunctions];
    ...
    /**
     * <p>This method searches through junctionStack for the Junction with (x,y) coordinates
