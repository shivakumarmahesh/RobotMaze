/*
 * The file Ex1.java is a part of the second course-work required to be submitted for evaluation
 * of the CS118 module. 
 * 
...
public class Ex1 {
	...
	public void backtrackControl(IRobot robot) {
		...
		switch(exits) {
	    	...
	    	case 4: 
	    		...
	    		//If the junction hasn't been visited before:
	            if(beenbeforeExits(robot) <= 1) {
	            	robotData.recordJunction(robot);
	           		robotData.printJunction();
	           	}
	            ...
	            if(passageExits(robot) > 0) {
	           	...
	           	//If there are no passage Exits:
	           		...
	           		/*Sets the Robot's heading to the reverse of the heading the Robot first 
	           		 *arrived at the Junction with. 
	           		 */
	 ...
	 * 
	 * @param robot This is the object from the IRobot Class that is used throughout this source code.
	 * @return the number of exits surrounding the Robot that it has traversed before.
	 */
...
class RobotData {
    ...
    //searchJunction method assumes robot is at a Junction,
    //with no passage Exits.
	...
	/**
	 * <p>This method is used to find the heading the Robot arrived with the first time it 
	 * arrived at a particular Junction. This method is called only when the Robot is at a Junction.
	 * </p>
	 * @param robot This is the object from the IRobot Class that is used throughout this source code.
    ...
    public int searchJunction(IRobot robot) {
    	...
    	int junctionIndex = findJunctionIndex(robot);
    	
    	junctionHeading = junctionArray[junctionIndex].arrived;
